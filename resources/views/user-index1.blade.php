                                ...
                                <table id="datatable" class="table table-bordered table-hover" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Nama</th>
                                            <th>Jenis<small style="color: #fff;">_</small>Kelamin</th>
                                            <th>No.<small style="color: #fff;">_</small>Handphone</th>
                                            @if ($user_type_id == 2)
                                                <th>Dinas<small style="color: #fff;">_</small>Kesehatan</th>
                                                <th>Alamat<small style="color: #fff;">_</small>Kantor</th>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="telephone" id="telephone"
                                        placeholder="Masukan No. Handphone (Handphone)" autocomplete="off"
