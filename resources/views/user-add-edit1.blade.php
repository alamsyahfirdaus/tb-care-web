                                        ...
                                        @if ($user_type_id == 3)
                                            <div class="form-group row">
                                                <label for="coord_type_id"
                                                    class="col-sm-2 col-form-label">Koordinator</label>
                                                <div class="col-sm-10">
    ...
    <script>
        $(function() {
            ...
            function validateStep2() {
                ...
                if (phone === '') {
                    setValidationError('phone', 'Bidang telepon wajib diisi.');
                    valid = false;
                } else if (!/^\d+$/.test(phone)) {
                    setValidationError('phone', 'Telepon harus berupa angka.');
                    valid = false;
                }
                ...
                if (userId === '') {
                    if (userTypeId === '2') {
                        ...
                        if (coordinatorType === '') {
                            setValidationError('coord_type_id', 'Bidang Koordinator wajib dipilih.');
                            valid = false;
                        }
            ...
            $('#email, #password, #name, #phone, #gender, #place_of_birth, #date_of_birth, #office_type_id, #office_address, #district_id, #puskesmas_id')
