...
return [
    ...
    */
    ...
    'boolean' => $attr . ' harus benar atau salah.',
    ...
    'distinct' => $attr . ' memiliki nilai duplikat.',
    ...
    'filled' => $attr . ' harus memiliki nilai.',
    'gt' => [
    ...
    'in_array' => $attr . ' tidak ada dalam :other.',
    ...
    'password' => $attr . ' salah.',
    'present' => $attr . ' harus ada.',
    'prohibited' => $attr . ' dilarang.',
    'prohibited_if' => $attr . ' dilarang ketika :other adalah :value.',
    'prohibited_unless' => $attr . ' dilarang kecuali :other ada dalam :values.',
    'prohibits' => $attr . ' melarang :other untuk hadir.',
    'regex' => 'Format :attribute tidak valid.',
    'required' => $attr . ' harus diisi.',
    'required_array_keys' => $attr . ' harus berisi entri untuk: :values.',
    'required_if' => $attr . ' diperlukan ketika :other adalah :value.',
    'required_unless' => $attr . ' diperlukan kecuali :other ada dalam :values.',
    'required_with' => $attr . ' diperlukan ketika :values ada.',
    'required_with_all' => $attr . ' diperlukan ketika :values ada.',
    'required_without' => $attr . ' diperlukan ketika :values tidak ada.',
    'required_without_all' => $attr . ' diperlukan ketika tidak ada satu pun dari :values ada.',
    ...
    */
    ...
    'attributes' => [
        ...
        'coord_type_id' => 'Koordinator',
        'treatment_type' => 'Jenis Pengobatan',
        'treatment_duration' => 'Durasi Pengobatan',
